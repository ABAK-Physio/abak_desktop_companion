              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      _version.isEmpty
                          ? s.information_versionLoading
                          : s.information_version(_version),
                    ...
                    _InfoLine(
                      ...
                      value: hasLogo
                          ? s.information_configured
                          : s.information_notConfigured,
                    ),
                    _InfoLine(
                      label: s.information_system,
                      value: _platform.isEmpty
                          ? s.information_loading
                          : _platform,
                    ),
                    _InfoLine(
                      label: s.information_language,
                      value: _language.isEmpty
                          ? s.information_loading
                          : _language,
                    ),
                    ...
                    if (_health != null) ...[
                      _InfoLine(
                        ...
                        value: s.information_size(
                          _formatFileSize(_health!.databaseSizeBytes),
                        ),
                      ),
                      _InfoLine(
                        ...
                        value:
                            ...
                            '${s.information_totalSize(_formatFileSize(_health!.backupsTotalSizeBytes))}',
                      ),
                    ],
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => const NouveautesScreen(),
                          ),
                        );
                      },
                      icon: const Icon(Icons.new_releases_outlined),
                      label: Text(s.information_newTitle),
                    ),
                    const SizedBox(height: 12),
                    OutlinedButton.icon(
